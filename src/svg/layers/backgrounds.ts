...
export const backgrounds: Accessory[] = [
	...
	{ name: "Light red", value: "#ffadad" },
	{ name: "Green", value: "#20d09a" },
	{ name: "Premium green", value: "#136F63" },
	{ name: "Purple", value: "rgba(117,42,219,0.89)" },
	{ name: "Rainbow", value: "url(#rainbow-vertical)" },
	{ name: "Yellow pink circle", value: "url(#yellow-to-pink-circle)" },
	{ name: "Purple green circle", value: "url(#purple-to-green-circle)" },
	{ name: "Shades of grey", value: "url(#shades-of-grey-vertical)" },
	{ name: "Space", value: "rgba(0,0,0,0.89)", children: [backgroundStars] },
]
