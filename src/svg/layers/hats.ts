...
const cosmonautHelmet: Accessory = {
...
const kingCrown: Accessory = {
  name: "King crown",
  value: (
    `<g id="king-crown" transform="translate(0 -1)">
			<path d="M1180.083,280.231c-1.292.622,0-10.1,0-10.1l3.84,3.607,3.674-6.408,2.667,6.408,3.886-3.607v10.1S1181.375,279.609,1180.083,280.231Z" transform="translate(-1139 -251)" fill="url(#purple-green-vertical)"/>
