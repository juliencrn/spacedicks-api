...
export const defs: Record<string, string> = {
	...
	"url(#mouth-filter)": (
		`<filter id="mouth-filter" x="33.642" y="27.524" width="21.683" height="20.087" filterUnits="userSpaceOnUse">
			<feOffset dy="3" input="SourceAlpha"/>
			<feGaussianBlur stdDeviation="3" result="blur"/>
			<feFlood flood-opacity="0.161"/>
			<feComposite operator="in" in2="blur"/>
	...
	"url(#small-mouth-filter)": (
		`<filter id="small-mouth-filter" x="37.566" y="32.676" width="21.655" height="20.857" filterUnits="userSpaceOnUse">
			<feOffset dy="3" input="SourceAlpha"/>
			<feGaussianBlur stdDeviation="3" result="blur-2"/>
			<feFlood flood-opacity="0.161"/>
			<feComposite operator="in" in2="blur-2"/>
